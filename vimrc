...
:inoremap ,.b( \left(\right)<Esc>hhhhhhi
:inoremap ,.b{ \left\{\right\}<Esc>hhhhhhhi
:inoremap ,.b[ \left[\right]<Esc>hhhhhhi
:inoremap ,.al \begin{align*}<CR>\end{align*}<Esc>ko<Space><Space>
:inoremap ,.fl \begin{flalign*}<CR>\end{flalign*}<Esc>ko<Space><Space>
:inoremap ,.ml \begin{multline*}<CR>\end{multline*}<Esc>ko<Space><Space>
:inoremap ,.eq \begin{equation*}<CR>\end{equation*}<Esc>ko<Space><Space>
:inoremap ,.ga \begin{gather*}<CR>\end{gather*}<Esc>ko<Space><Space>
:inoremap ,.ar \begin{array}<CR>\end{array}<Esc>ko<Space><Space>
